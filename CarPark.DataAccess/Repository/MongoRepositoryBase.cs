...
namespace CarPark.DataAccess.Repository
{
    public class MongoRepositoryBase<TEntity> : IRepository<TEntity> where TEntity : class, new()
    {
        ...
        public async Task<GetManyResult<TEntity>> GetAllAsync()
        {
            ...
            {
                result.Message = $"AsQeryableAsync {ex.Message}";
                result.Succes = false;
                result.Result = null;
        ...
        public async Task<GetOneResult<TEntity>> GetByIdAsyc(string id)
        {
            var result = new GetOneResult<TEntity>();
            try
            {
            ...
            {
                result.Message = $"GetByIdAsyc {ex.Message}";
                result.Succes = false;
                result.Entity = null;
        ...
        public async Task<GetOneResult<TEntity>> DeleteByIdAsyc(string Id)
        {
            ...
            {
                result.Message = $"DeleteByIdAsyc {ex.Message}";
                result.Succes = false;
                result.Entity = null;
